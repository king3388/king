...
<div id="left">
    <ul class="left_date" id="setting">   
        ...
        <li><a href="./system/modules/admin/shouquan.jpg" src="<?php echo G_MODULE_PATH; ?>/setting/empower">授权证书</a></li>
...
<div id="right">
	<div class="right_top">
		...
		<a href="http://idc.52jscn.com" target="_blank" class="system_button"><span>站长主机</span></a>		
