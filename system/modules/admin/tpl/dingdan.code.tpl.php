...
<!--start-->
		...
		<div class="dingdan_content">
			...
			<?php
				$list=explode(",",$record['goucode']);
				$st="";
				$html='b';
				foreach ($list as $value) {
					if($value==$qishu['ma']){
						$st.="<".$html." style='color:red;width:70px;display:inline-block;'>".$value."</".$html.">";
					}else{
						$st.="<".$html." style='width:70px;display:inline-block;font-weight: normal;'>".$value."</".$html.">";
					}
				}
				echo $st;
			?>
