...
<head>
	...
	<link href="<?php echo G_TEMPLATES_CSS; ?>/mobile/demo/swiper.min.css" rel="stylesheet" type="text/css" />
	<script src="<?php echo G_TEMPLATES_CSS; ?>/mobile/demo/swiper.min.js" language="javascript" type="text/javascript"></script>
		...
		<div class="swiper-container">
			<div class="swiper-wrapper">
				<?php $ln=1;if(is_array($slides)) foreach($slides AS $slide): ?>
					<?php if($ln == 1): ?>
						<div class="swiper-slide"> <a href="<?php echo $slide['link']; ?>" target="_blank"><img src="<?php echo G_UPLOAD_PATH; ?>/<?php echo $slide['img']; ?>"></a> </div>
					<?php  else: ?>
						<div class="swiper-slide"> <a href="<?php echo $slide['link']; ?>" target="_blank"><img src="<?php echo G_UPLOAD_PATH; ?>/<?php echo $slide['img']; ?>"></a> </div>
					<?php endif; ?>
            ...
            $qishu['q_user'] = unserialize($qishu['q_user']);
             ?>
				<li>
					...
					<?php  else: ?>
					<span style="color:#8E95F7;">无人获奖 T.T</span>
					<?php endif; ?>
				</li>
			<?php  endforeach; $ln++; unset($ln); ?>     
