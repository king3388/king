...
<!-- 内页顶部 -->
    ...
    <section class="clearfix g-member g-Record-ctlst">
	    ...
	    <article class="m-round">
		    <h3>本期商品您总共拥有<em class="orange"><?php echo $itemlist['0']['gonumber']; ?></em>个云购码</h3>
		    <ul>
			<?php $ln=1;if(is_array($itemlist)) foreach($itemlist AS $val): ?>			 
			    <li><p class="gray9">参与时间：<?php echo microt($val['timego']); ?><span>参与了<?php echo $val['gonumber']; ?>人次，</span></p><b><?php echo yunma($val['goucode'],"b"); ?></b></li>
