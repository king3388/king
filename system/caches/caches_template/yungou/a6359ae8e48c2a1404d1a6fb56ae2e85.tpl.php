...
<head>
    ...
    <title>云购结果 - <?php echo $webname; ?>触屏版</title>
...
<!-- 内页顶部 -->
    ...
    <header class="g-header">
        <div class="head-l">
	        <a href="<?php echo WEB_PATH; ?>/mobile/mobile"  class="z-HReturn"><s></s><b>首页</b></a>
        </div>
        <h2>云购结果</h2>
        <div class="head-r">
		...
		<div class="u-Btn"><div class="u-Btn-li"><a href="<?php echo WEB_PATH; ?>/mobile/home/userbuylist" class="z-CloseBtn">查看云购记录</a></div><div class="u-Btn-li"><a href="<?php echo WEB_PATH; ?>/mobile/mobile" class="z-DefineBtn">继续购物</a></div></div>		 
		</section>
    </div>
