	     ...
	     <li class="m-xs-li" txt="<?php echo $shop['time_H']; ?>点">
            <div class="m-round limit-bd limit-End">
                ...
                <div class="clearfix gray9 limit-user">
                    ...
                    <p class="m-limit-Code">幸运云购码：<em class="orange"><?php echo $shop['q_user_code']; ?></em>
                    </p>
                    <p>
                        云购人次：<?php echo $user_shop_number[$shop['q_uid']][$shop['id']]; ?>
                    </p>
                </div>
            </div>
        </li>
            ...
            <div class="m-round limit-bd ">
                ...
                <div class="u-Btn">
				   <?php if($shop['canyurenshu']==$shop['zongrenshu']): ?>
					...
					<?php  else: ?>
					<div class="u-Btn-li">
						<a href="javascript:;" class="z-ShoppingBtn" id="<?php echo $shop['id']; ?>">立即1元云购</a>
					</div>
					<div class="u-Btn-li">
