...
<!-- 内页顶部 -->
    ...
    <input name="hidCodeQuantity" type="hidden" id="hidCodeQuantity" value="<?php echo $item['zongrenshu']; ?>" />
    <input name="hidYuShu" type="hidden" id="hidYuShu" value="<?php echo $user_shop_fmod; ?>" />
	<input name="hidLottery" type="hidden" id="hidLottery" value="<?php echo $item['lottery_num']; ?>" />
	<input name="hidLotteryQishu" type="hidden" id="hidLotteryQishu" value="<?php echo $item['lottery_period']; ?>" />
