...
<link rel="stylesheet" type="text/css" href="<?php echo G_TEMPLATES_CSS; ?>/demo/demo.css"/>
<script type="text/javascript" src="<?php echo G_TEMPLATES_CSS; ?>/demo/superslide.2.1.js"></script>
</head>
<body>
<div class="header">
	<div class="site_top">
