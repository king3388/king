...
var i = <?php echo $time; ?>;	if(i!=0){window.close_id = setInterval(function() {if (i > 0) {document.getElementById('time').innerHTML = i;i = i - 1;} else {
						 location.href="<?php echo $defurl; ?>";	  clearInterval(window.close_id);}}, 1000);}</script>
...
<div class="box">
	<div class="box-b">
        ...
        <div class="box-button"><a class="a-2" href="<?php echo $defurl; ?>"><font id="time" style="color:red;"><?php echo $time; ?></font>秒后返回上一页面</a><a class="a-1" href="<?php echo $str_url_two['url']; ?>"><?php echo $str_url_two['text']; ?></a></div> 
