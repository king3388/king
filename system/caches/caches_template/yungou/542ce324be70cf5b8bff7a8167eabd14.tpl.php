				...
				<div class="GetPrize">				    
					<dl>
						...
						<dd class="gray02">
							...
							<p>云购时间：<?php echo microt($sid_go_record['time']); ?></p>
							<p>幸运云购码：<em class="orange Fb"><?php echo $sid_code['q_user_code']; ?></em></p>
						</dd>
					</dl>				
				</div>
			</div>
			...
			<div class="Pro_Record">
				...
				<div class="My_Record hide" style="display:none;">
					...
					<ul>
						...
						<li><?php echo _put_time($user['time']); ?>  云购了  <?php echo $user['gonumber']; ?>  个云购码</li>
						<?php endif; ?>
						<?php  endforeach; $ln++; unset($ln); ?>
					</ul>
					<?php  else: ?>
				...
				<div class="Newest_Con hide" style="display:none;">
					<p class="MsgIntro"><?php echo _cfg("web_name_two"); ?>购是指只需1元就有机会买到想要的商品。即每件商品被平分成若干“等份”出售，每份1元，当一件商品所有“等份”售出后，根据云购规则产生一名幸运者，该幸运者即可获得此商品。</p>
					<p class="MsgIntro1"><?php echo _cfg("web_name_two"); ?>以“快乐云购，惊喜无限”为宗旨，力求打造一个100%公平公正、100%正品保障、寄娱乐与购物一体化的新型购物网站。<a href="<?php echo WEB_PATH; ?>/help/1" class="blue" target="_blank">查看详情&gt;&gt;</a></p>
				</div>
			</div>			
		</div>
	</div>
...
<div id="divContent" class="Product_Content">
	...
	<div id="divPost" class="Single_Content">
		<iframe id="iframea" src="<?php echo WEB_PATH; ?>/go/shaidan/itmeifram/<?php echo $itemid; ?>" style="width:978px; border:none;height:0px;" frameborder="0" scrolling="no"></iframe>
	</div>
