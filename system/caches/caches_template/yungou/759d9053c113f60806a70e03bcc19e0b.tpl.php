<?php defined('G_IN_SYSTEM')or exit('No permission resources.'); ?><div class="Progress-bar">
				<p title="已完成<?php echo percent($item['canyurenshu'],$item['zongrenshu']); ?>"><span style="width:<?php echo width($item['canyurenshu'],$item['zongrenshu'],450); ?>px; display:;"></span></p>
				<ul class="Pro-bar-li">
			...
			<p class="Pro_Detsingle" style="font-size:14px;">云购价格：<b style="color:#999;"><?php echo $item['yunjiage']; ?></b></p>
