	...
	<div id="divTimerItems" class="showCon" style="display:block;">
		<ul>        	
			...
			<li class="autolist autolistEnd jinrishop">         
                ...
                <div class="listEndInfo">
					<div class="uInfo">
					<p><font style="color:red;">此次活动无人中奖 T.T</font><br>幸运云购码：<span class="orange"><?php echo $shop['q_user_code']; ?></span><br>揭晓时间：<span>
                <?php echo date("Y-m-d H:i:s",$shop['q_end_time']); ?>.000
                </span></p></div></div>
                <?php endif; ?>
			</li>
					...
					<ul class="autoOldlist">
						<li class="pInfo">
							<dt><a rel="nofollow" href="<?php echo WEB_PATH; ?>/dataserver/<?php echo $eshop['id']; ?>" target="_blank">
								<img border="0" src="<?php echo G_UPLOAD_PATH; ?>/<?php echo $eshop['thumb']; ?>" alt="三星（Samsung）840系列MZ-7TD120BW 120G固态硬盘"></a></dt>
	...
	<div class="autoRule">
		...
		<div class="autoOldC">
			<ul>
				...
				<li>4、限时揭晓商品不参与差价送福分活动且晒单不可再获得1000福分奖励。</li>
