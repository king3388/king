...
<head>
    ...
    <title>获得的商品 - <?php echo $webname; ?>触屏版</title>
...
<!-- 内页顶部 -->
    ...
    <section class="clearfix g-member g-goods">
        <ul id="ulListBox" class="z-minheight">
			...
			<!-- <?php $ln=1;if(is_array($record1)) foreach($record1 AS $recd): ?>
			<li onclick="location.href='<?php echo WEB_PATH; ?>/mobile/user/buyDetail/<?php echo $recd['id']; ?>'" class="bornone"><a class="fl z-Limg" href="<?php echo WEB_PATH; ?>/mobile/mobile/item/<?php echo $recd['id']; ?>"><img src="<?php echo G_UPLOAD_PATH; ?>/<?php echo $recd['thumb']; ?>" border="0" alt=""></a><div class="u-gds-r gray9"><p class="z-gds-tt"><a href="<?php echo WEB_PATH; ?>/mobile/mobile/item/<?php echo $recd['id']; ?>" class="gray6">(第<?php echo $recd['qishu']; ?>期)<?php echo $recd['title']; ?></a></p><p>幸运云购码：<em class="orange"><?php echo $recd['q_user_code']; ?></em></p><p>揭晓时间：<?php echo microt($recd['q_end_time']); ?></p></div><b class="z-arrow"></b></li>
