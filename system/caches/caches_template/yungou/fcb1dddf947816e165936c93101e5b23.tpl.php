...
$(function(){
    $('#file_upload').uploadify({
		...
		'progressData' :'speed',
        'swf'      : '<?php echo G_TEMPLATES_STYLE; ?>/js/uploadify.swf',
        'uploader' : '<?php echo WEB_PATH; ?>/member/home/userphotoup',
        'method'   : 'post',
		'buttonText' : '选择图片',
		'buttonImage': '<?php echo G_TEMPLATES_STYLE; ?>/img/upload.gif',
		'width': 94,
		'height': 27,
        'multi'    : true,
        'uploadLimit' : 5,
...
function SetImgContent(data){
	...
	if(data == ''){
		...
		var sLi = "";
		sLi += '<img  id="xuwanting" src="<?php echo G_UPLOAD_PATH; ?>/'+data+'">';
		return sLi;
	}
}
function SetImgphoto(data){
	if(data == ''){		
		...
		sLi160 += '<img id="crop_preview" src="<?php echo G_UPLOAD_PATH; ?>/'+data+'">';
		sLi160 += '</div></div>160X160 像素</li>';
		sLi160 += '<li class="li80"><div class="w80"><div id="w80">';
		sLi160 += '<img id="crop_preview2" src="<?php echo G_UPLOAD_PATH; ?>/'+data+'">';
		sLi160 += '</div></div>80X80 像素</li>';
		sLi160 += '<li class="li30"><div class="w30"><div id="w30">';
		sLi160 += '<img id="crop_preview3" src="<?php echo G_UPLOAD_PATH; ?>/'+data+'">';
...
<div class="R-content">
	...
	<div class="uploadCon" style="margin-top:20px;">
		<div class="upLeft">
			...
			<div class="savePhoto">
				<form action="<?php echo WEB_PATH; ?>/member/home/userphotoinsert" method="post" id="crop_form">
		...
		<div class="upRight">
			...
			<div class="photo gray02">
				<ul>
					<?php if(empty($member['img']) || $member['img'] == "photo/member.jpg"): ?>				
					<li class="li160"><div class="w160"><div id="w160"><img id="crop_preview" src="<?php echo G_UPLOAD_PATH; ?>/photo/member.jpg_160.jpg" width="160" height="160"  /></div></div>160X160 像素</li>
					<li class="li80"><div class="w80"><div id="w80"><img id="crop_preview2" src="<?php echo G_UPLOAD_PATH; ?>/photo/member.jpg_80.jpg" width="80" height="80"  /></div></div>80X80 像素</li>
					<li class="li30"><div class="w30"><div id="w30"><img id="crop_preview3" src="<?php echo G_UPLOAD_PATH; ?>/photo/member.jpg_30.jpg" width="30" height="30"  /></div></div>30X30 像素</li>					
					<?php  else: ?>			
					<li class="li160"><div class="w160"><div id="w160"><img id="crop_preview" src="<?php echo G_UPLOAD_PATH; ?>/<?php echo $member['img']; ?>_160160.<?php echo img($member['img']); ?>" /></div></div>160X160 像素</li>
					<li class="li80"><div class="w80"><div id="w80"><img id="crop_preview2" src="<?php echo G_UPLOAD_PATH; ?>/<?php echo $member['img']; ?>_8080.<?php echo img($member['img']); ?>" /></div></div>80X80 像素</li>
					<li class="li30"><div class="w30"><div id="w30"><img id="crop_preview3" src="<?php echo G_UPLOAD_PATH; ?>/<?php echo $member['img']; ?>_3030.<?php echo img($member['img']); ?>" /></div></div>30X30 像素</li>					
					<?php endif; ?>
				</ul>
			</div>
		</div>
