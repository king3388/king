    ...
    <section class="clearfix g-Cart">
	    <?php if($shop!=0): ?>
	        <article class="clearfix m-round g-Cart-list">
				...
				<?php 
            	   $num = count($shoplist);
				   $buyshopmoney+=$Mcartlist[$val['id']]['num'];
                 ?>    
					<li>		            
						...
						<div class="u-Cart-r">
							...
							<p class="gray9">总共云购：<em class="arial"><?php echo $Mcartlist[$val['id']]['num']; ?></em>人次/<em class="orange arial">￥<?php echo $Mcartlist[$val['id']]['num']; ?>.00</em></p>
							<p class="f-Cart-Other">
								...
								<input id="txtNum<?php echo $val['id']; ?>" name="num" type="text" maxlength="7" value="<?php echo $Mcartlist[$val['id']]['num']; ?>" class="fl z-amount" />
	    ...
	    <div id="divBtmMoney" class="g-Total-bt"><p>总共云购
