...
<div class="referrals_box">
	<div class="W-left fl">
		...
		<div class="referrals_banner">
			<ul>
			<li><img src="<?php echo G_TEMPLATES_STYLE; ?>/images/referrals_01.jpg" border="0" alt=""></li>
			<li><img src="<?php echo G_TEMPLATES_STYLE; ?>/images/referrals_02.jpg" border="0" alt=""></li>
			</ul>
		</div>
